...
export function setToken(token: string) { setItem(TOKEN_KEY, token); }
export function getToken(): string | null { return getItem(TOKEN_KEY); }
export function clearToken() { removeItem(TOKEN_KEY); }
